          ...
          <>
            ...
            >
              ...
              <div className="flex items-center gap-3">
                <FaHeartbeat className="h-7 w-7 text-rose-500 animate-pulse-heart" />
                <span className="font-display font-bold text-base tracking-wide bg-gradient-to-r from-rose-400 to-sky-400 bg-clip-text text-transparent">
                  Cardiocare-ai
                </span>
              </div>
    ...
    <div className="flex-1 flex flex-col min-w-0 overflow-x-hidden">
      ...
      <header className="h-16 bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between px-6 sticky top-0 z-10 shadow-sm transition-colors duration-300">
        ...
        <div className="flex items-center gap-4">
          ...
          <h2 className="font-display font-bold text-sm sm:text-lg text-slate-800 dark:text-slate-100 truncate max-w-[140px] sm:max-w-none">
